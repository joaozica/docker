...
To create the image `postgresql`, execute the following command on the docker-postgresql folder:
...
set the environment variable `POSTGRES_PASS` to your specific password when running the container:
	...
	docker run -d -p 5432:5432 -e POSTGRES_PASS="mypass" postgresql
